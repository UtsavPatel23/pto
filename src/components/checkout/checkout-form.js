		...
		<>
			...
			{cart ? (
				<div key="check-outform">
						...
						<div className='border border-gray-200 p-3 rounded max-w-2xl mx-auto'>
							...
							<div key='setguestcheckout'>
								<button
									...
									onClick={() => {
										guestCheckOut ? setGuestCheckOut(false) : setGuestCheckOut(true)
									}}>
									Continue as guest
								</button>
							</div>
					...
					{guestCheckOut || tokenValid ?
						<form onSubmit={handleFormSubmit} id="checkout_form" className="woo-next-checkout-form">
							<div className="grid grid-cols-1 md:grid-cols-2 gap-10">
								<div className='space-y-5'>
									{/*Billing Details*/}
									<div className='billing-details shadow-full p-3 space-y-3'>
										<h2 className="font-jost text-2xl font-semibold mb-5">Billing Details</h2>
										<Address
									...
									<div className='billing-details shadow-full p-3 space-y-3'>
										<h4 className="font-jost text-2xl font-semibold mb-5">Additional Information</h4>
										<TextArea
											name="orderNotes"
											handleOnChange={handleOnChange}
											errors={input?.errors ? input.errors : null}
									...
									<div className='billing-details shadow-full p-3 space-y-3'>
										...
										{input?.billingDifferentThanShipping ? (
											<div className="billing-details space-y-5">
												<h2 className="font-jost text-2xl font-semibold mb-5">Shipping Details</h2>
												<Address
								...
								{/* Order & Payments*/}
								<div className='order-summ shadow-full p-3 h-fit sticky top-5'>
									{/*	Order*/}
									<h2 className="text-center font-jost text-2xl font-semibold mb-5">Order Summary</h2>
									...
									{createdOrderData?.allData?.payment_method == 'ppcp-gateway' && paypalButtonBisible ? <>
										...
										<div id='checkoutbtn' className="woo-next-place-order-btn-wrap mt-5">
											<button
												...
												className={`bg-victoria-700 text-white px-5 py-3 w-full ${isOrderProcessing ? 'opacity-50' : ''}`}
												type="submit"
											>
												Place Order
											</button>
